...
final class Template
{
    ...
    {
        return new self($this->name, array_merge($this->data, $data), $this->attributes, $this->reference,
            $this->parent);
    }
    ...
    {
        return new self($this->name, $this->data, array_merge($this->attributes, $attributes), $this->reference,
            $this->parent);
    }
